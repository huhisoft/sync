...
(function(global, factory) { /* global define, require, module */
    ...
    $root.api = (function() {
            ...
            SecretboxRecord.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if (options.bytes === String)
                        ...
                        object.nonceRandom = [];
                        if (options.bytes !== Array)
                            object.nonceRandom = $util.newBuffer(object.nonceRandom);
                    }
                }
                if (message.encryptedData != null && message.hasOwnProperty("encryptedData"))
        ...
        api.MetaInfo = (function() {
    
            /**
             * Properties of a MetaInfo.
             * @memberof api
             * @interface IMetaInfo
             * @property {string|null} [key] MetaInfo key
             * @property {string|null} [value] MetaInfo value
             */
             ...
             * @constructor
             * @param {api.IMetaInfo=} [properties] Properties to set
             */
             ...
             * MetaInfo key.
             * @member {string} key
             * @memberof api.MetaInfo
             * @instance
             */
            MetaInfo.prototype.key = "";
             ...
             * @static
             * @param {api.IMetaInfo=} [properties] Properties to set
             * @returns {api.MetaInfo} MetaInfo instance
             */
            ...
            /**
             * Encodes the specified MetaInfo message. Does not implicitly {@link api.MetaInfo.verify|verify} messages.
             * @function encode
             * @memberof api.MetaInfo
             * @static
             * @param {api.IMetaInfo} message MetaInfo message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified MetaInfo message, length delimited. Does not implicitly {@link api.MetaInfo.verify|verify} messages.
             * @function encodeDelimited
             * @memberof api.MetaInfo
             * @static
             * @param {api.IMetaInfo} message MetaInfo message or plain object to encode
            ...
            MetaInfo.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.api.MetaInfo();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            MetaInfo.fromObject = function fromObject(object) {
                if (object instanceof $root.api.MetaInfo)
                    return object;
                var message = new $root.api.MetaInfo();
                if (object.key != null)
             ...
             * @memberof api.MetaInfo
             * @static
             * @param {api.MetaInfo} message MetaInfo
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
        ...
        api.SyncRecord = (function() {
            ...
            SyncRecord.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if (options.bytes === String)
                        ...
                        object.objectId = [];
                        if (options.bytes !== Array)
                            object.objectId = $util.newBuffer(object.objectId);
                    }
                }
                if (message.action != null && message.hasOwnProperty("action"))
            ...
            SyncRecord.Bookmark = (function() {
                 ...
                 * @property {string|null} [order] Bookmark order
                 * @property {Array.<api.IMetaInfo>|null} [metaInfo] Bookmark metaInfo
                 */
                 ...
                 * @instance
                 */
                Bookmark.prototype.metaInfo = $util.emptyArray;
                ...
                Bookmark.encode = function encode(message, writer) {
                    ...
                    if (message.order != null && message.hasOwnProperty("order"))
                        writer.uint32(/* id 8, wireType 2 =*/66).string(message.order);
                    if (message.metaInfo != null && message.metaInfo.length)
                        for (var i = 0; i < message.metaInfo.length; ++i)
                            $root.api.MetaInfo.encode(message.metaInfo[i], writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                    return writer;
                };
                ...
                Bookmark.fromObject = function fromObject(object) {
                    ...
                    if (object.metaInfo) {
                        if (!Array.isArray(object.metaInfo))
                            throw TypeError(".api.SyncRecord.Bookmark.metaInfo: array expected");
                        message.metaInfo = [];
                        for (var i = 0; i < object.metaInfo.length; ++i) {
                            if (typeof object.metaInfo[i] !== "object")
                                throw TypeError(".api.SyncRecord.Bookmark.metaInfo: object expected");
                ...
                Bookmark.toObject = function toObject(message, options) {
                    ...
                    if (options.defaults) {
                        ...
                        if (options.bytes === String)
                            object.parentFolderObjectId = "";
                        else {
                            object.parentFolderObjectId = [];
                            if (options.bytes !== Array)
                                object.parentFolderObjectId = $util.newBuffer(object.parentFolderObjectId);
                        }
                        if (options.bytes === String)
                            object.previousObjectId = "";
                        else {
                            object.previousObjectId = [];
                            if (options.bytes !== Array)
                                object.previousObjectId = $util.newBuffer(object.previousObjectId);
                        }
                        if (options.bytes === String)
                            object.nextObjectId = "";
                        else {
                            object.nextObjectId = [];
                            if (options.bytes !== Array)
                                object.nextObjectId = $util.newBuffer(object.nextObjectId);
                        }
            ...
            SyncRecord.SiteSetting = (function() {
                ...
                SiteSetting.toObject = function toObject(message, options) {
                    ...
                    if (options.defaults) {
                        ...
                        object.adControl = options.enums === String ? "SHOW_HUHI_ADS" : 0;
                 ...
                 * @enum {string}
                 * @property {number} SHOW_HUHI_ADS=0 SHOW_HUHI_ADS value
                ...
                SiteSetting.AdControl = (function() {
                    var valuesById = {}, values = Object.create(valuesById);
                    values[valuesById[0] = "SHOW_HUHI_ADS"] = 0;
