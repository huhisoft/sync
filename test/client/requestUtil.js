  ...
  const testPrototype = (t, requestUtil, keys) => {
    ...
    const testCanPutHistorySite = (t) => {
      const record = {
        ...
        historySite: {
          location: `https://huhi.com?q=${'x'.repeat(4048)}`,
          title: 'lulz',
    ...
    const testCanPutBookmarks = (t) => {
      const record = {
        ...
        bookmark: {
          site: {
            location: `https://huhi.com?q=${'x'.repeat(4)}`,
            title: 'lulz',
            lastAccessedTime: 1480000000 * 1000,
            creationTime: 1480000000 * 1000
          },
      ...
      const record2 = {
        ...
        bookmark: {
          site: {
            location: `https://huhi.com?q=${'x'.repeat(4096)}`,
            title: 'lulz2',
            lastAccessedTime: 1480000000 * 1000,
            creationTime: 1480000000 * 1000
          },
